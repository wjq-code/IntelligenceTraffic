...
public class DateUtils {
    ...
    public static final SimpleDateFormat TIME_FORMAR = new SimpleDateFormat("yyyy-MMdd HH:mm:ss");
    public static final SimpleDateFormat DATE_FORMAR = new SimpleDateFormat("yyyy-MM-dd");
    public static final SimpleDateFormat DATEKEY_FORMAR = new SimpleDateFormat("yyyyMMdd");
    ...
    public static boolean before(String time1, String time2) throws ParseException {
        //将传递的字符串转换为日期
        Date date1 = TIME_FORMAR.parse(time1);
        Date date2 = TIME_FORMAR.parse(time2);
    ...
    public static String getTodayDate() {
        return DATE_FORMAR.format(new Date());
    }
    ...
    public static String getYesterdayDate() {
        ...
        return DATE_FORMAR.format(date);
    }
    ...
    public static String formatTime(Date date) {
        return TIME_FORMAR.format(date);
    }
    ...
    public static String formatDateKey(Date date) {
        return DATEKEY_FORMAR.format(date);
    }

    public static Date parseDateKey(String time) {
        try {
            return DATEKEY_FORMAR.parse(time);
        } catch (ParseException e) {
            return null;
        }
    }
